...
const Services: React.FC = () => {
  return (
    <section className="py-20 md:py-40 bg-white overflow-hidden" id="services">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
        <div className="mb-16 md:mb-32 flex flex-col lg:flex-row lg:items-end justify-between gap-8 md:gap-12">
          <div className="max-w-3xl">
            <h2 className="text-[10px] md:text-xs font-bold tracking-[0.4em] md:tracking-[0.5em] uppercase text-[#D4AF37] mb-6 md:mb-8 flex items-center gap-3 md:gap-4">
              <span className="w-8 md:w-12 h-px bg-[#D4AF37]"></span>
              Expertise & Verticals
            </h2>
            <h3 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-light tracking-tight text-[#1A1A1A] leading-[1.1]">
              The architecture of <br />
              <span className="italic font-bold text-[#D4AF37]">Brand Influence.</span>
            </h3>
          </div>
          <p className="text-slate-500 max-w-sm text-base md:text-lg font-light leading-relaxed border-l border-[#D4AF37]/30 pl-6 md:pl-8">
